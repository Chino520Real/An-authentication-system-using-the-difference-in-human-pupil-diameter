"""
The third experiment: Moving shapes.
Duration: 5 seconds + 10 times of shape moving
Color combinations:
    1.Red and Blue
    2.Yellow and Blue
    3.Red and Green
...
Process:
    ...
    2.播放5s纯色
    3.播放图形移动5次（共7s）
    4.重复2-3，直到10次结束（共120s）
    5.点击空格下一个颜色组合
    6.重复2-4，直到4组颜色组合结束（共480s）
"""
...
imgDir = 'D:\\University\\manaba\\murao\\B4\\pupil_diameter\\Programs\\Images\\Experiment3\\ColorCombination'
