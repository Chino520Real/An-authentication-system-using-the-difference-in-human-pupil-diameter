...
episode_list = [(WHITE, BLACK), (RED, BLUE), (YELLOW, BLUE), (RED, GREEN), (GREEN, BLUE)]
...
def generate_gradient_surface(base_color, contrast_color, progress):
    ...
    # Draw the four side squares with gradients
    for y in range(square_rects[1].height):
        t_pos = y / (square_rects[1].height - 1)
        inner_edge_color = get_interp_color(base_color, contrast_color, progress)
