"""
The second experiment: Colored Circle.
Frequency: 3Hz
Dration: 5 seconds + 5 seconds
The times to repeat: 10 times
Color combinations:
    1.Red and Blue
    2.Yellow and Blue
    3.Red and Green
...
Process:
    1.开始画面，附带说明文，点击空格开始
    2.从5s的背景色开始，然后是5秒带颜色的圈
    3.播放一个颜色组合20次（200s）
    4.摁下空格，开始下一组颜色组合
    5.重复3-4，直到4组颜色组合结束（共800s）
"""
...
imgDir = 'D:\\University\\manaba\\murao\\B4\\pupil_diameter\\Programs\\Images\\Experiment2\\ColorCombination'
...
def run_experiment(episodes, repetitions=20, show_finish_screen=True):
    screen_w, screen_h = screen.get_size()
